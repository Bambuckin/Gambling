...
Status: Phase 2 in progress (`02-01`..`02-04` complete, `02-05` next).
...
Execute `02-05` in Phase 2 (`Access and Unified Shell`): add Access Lab test UI for post-implementation verification.
